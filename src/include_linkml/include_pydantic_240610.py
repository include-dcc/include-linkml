...
class Biospecimen(Thing):
    ...
    sampleAvailability: EnumSampleAvailability = Field(..., title="Sample Availability", description="""Whether or not the sample is potentially available for sharing through the Virtual Biorepository""")
    containerAvailability: Optional[EnumContainerAvailability] = Field(None, title="Container Availability", description="""Whether or not the container is potentially available for sharing through the Virtual Biorepository""")
...
class Study(Thing):
    ...
    expectedDataCategory: List[EnumDataCategory] = Field(default_factory=list, title="Expected Data Category", description="""Categories of data expected to be collected in this study""")
    studyWebsite: Optional[str] = Field(None, title="Study Website", description="""Website for the study""")
    studyDbgap: Optional[List[str]] = Field(default_factory=list, title="Study dbGaP", description="""dbGaP \"phs\" accession code(s) associated with this Study, either for access or informational purposes (pipe-separated if multiple)""")
    studyPublication: Optional[List[str]] = Field(default_factory=list, title="Study Publication", description="""URL for publication(s) describing the study's rationale and methodology (PubMed Central preferred but not required; pipe-separated if multiple)""")
    studyExpectedNumberOfParticipants: int = Field(..., title="Study Expected Number of Participants", description="""Expected number of participants in this study. If additional explanation is needed, please add to Study Description field.""")
...
class Dataset(Thing):
    ...
    datasetExpectedNumberOfParticipants: int = Field(..., title="Dataset Expected Number of Participants", description="""Expected number of participants in this dataset. If additional explanation is needed, please add to Dataset Description field.""")
    ...
    datasetDataCategory: EnumDataCategory = Field(..., title="Dataset Data Category", description="""General category of data in dataset; pipe-separated if multiple""")
    datasetDataType: Optional[str] = Field(None, title="Dataset Data Type", description="""Specific type of data contained in dataset; pipe-separated if multiple (e.g. Preprocessed metabolite relative abundance, Absolute protein concentration, Aligned reads, Simple nucleotide variations, GVCF, Gene expression quantifications, Gene fusions, Somatic copy number variations, Somatic structural variations)""")
    datasetExperimentalStrategy: Optional[str] = Field(None, title="Dataset Experimental Strategy", description="""Experimental method used to obtain data in dataset; pipe-separated if multiple (e.g. Whole genome sequencing, RNAseq, Multiplex immunoassay, Mass spec metabolomics)""")
    datasetExperimentalPlatform: Optional[str] = Field(None, title="Dataset Experimental Platform", description="""Specific platform used to perform experiment; pipe-separated if multiple (e.g. SOMAscan, MSD, Luminex, Illumina)""")
    datasetPublication: Optional[List[str]] = Field(default_factory=list, title="Dataset Publication", description="""URL for publication(s) describing the dataset's rationale and methodology (PubMed Central preferred but not required; pipe-separated if multiple)""")
    ...
    datasetDbgap: Optional[List[str]] = Field(default_factory=list, title="Dataset dbGaP", description="""dbGaP \"phs\" accession code(s) required to access the files in this Dataset, if applicable (pipe-separated if multiple)""")
